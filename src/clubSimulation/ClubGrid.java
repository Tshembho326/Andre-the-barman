/**
 * @author M. M. Kuttel and Tshembho Xivambu
 * XVMRHU001
 * M. M.'s Club Simulation
 *
 * */
...
ClubGrid {
	...
	private final PeopleCounter counter;

	/**
	 * Constructor for the ClubGrid class.
	 *
	 * @param x          The width of the grid.
	 * @param y          The height of the grid.
	 * @param exitBlocks The exit block positions.
	...
	public void leaveClub(GridBlock currentBlock, PeopleLocation myLocation) {
		synchronized (entranceLock) {
			counter.personLeft(); // Decrement counter for people inside
