...
/**
 * This class represents the graphical view of the club simulation.
 */
public class ClubView extends JPanel implements Runnable {
	...
	private PeopleLocation peopleLocation;
	ClubGrid grid; // shared grid

	/**
	 * Constructor for the ClubView class.
	 *
	 * @param custs The array of patron locations.
	 * @param grid  The club grid.
	 * @param exits The exit positions.
	 */
	ClubView(PeopleLocation[] custs, ClubGrid grid, int[] exits) {
